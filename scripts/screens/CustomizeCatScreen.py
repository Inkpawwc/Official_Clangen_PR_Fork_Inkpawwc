...
def get_selected_option(attribute, case):
    if isinstance(attribute, list):
        if (
            len(attribute) > 0
        ):  # selects an option in scar dropdowns for any existing scars
...
class CustomizeCatScreen(Screens):
    def __init__(self, name=None):
        ...
        self.tints = ["None"] + [
            tint
            for tint in list(sprites.cat_tints["tint_colours"].keys())
            + list(sprites.cat_tints["dilute_tint_colours"].keys())
            if tint != "none"
        ]
        self.tints.sort()
    ...
    def screen_switches(self):
        ...
        self.frame_image = pygame_gui.elements.UIImage(
            ui_scale(pygame.Rect((25, 120), (270, 270))),
            get_box(BoxStyles.FRAME, (250, 250)),
            starting_height=1,
        )
        self.build_cat_page()
    ...
    def build_cat_page(self):
        ...
        self.cat_elements["cat_name"] = create_text_box(
            "customize " + str(self.the_cat.name),
            (0, 40),
            (400, 40),
    ...
    def setup_labels(self):
        ...
        # ------------------------------------------------------------------------------------------------------------
        """
        self.pelt_name_label = create_text_box(
            "pelt name", (320, 100), (135, 40), "#text_box_22_horizleft"
        )
        self.pelt_colour_label = create_text_box(
            "pelt colour", (480, 100), (135, 40), "#text_box_22_horizleft"
        )
        self.pelt_length_label = create_text_box(
            "pelt length", (224, 500), (135, 40), "#text_box_22_horizleft"
        )
        self.pattern_label = create_text_box(
            "pattern", (640, 100), (135, 40), "#text_box_22_horizleft"
        )
        self.tortie_base_label = create_text_box(
            "tortie base", (320, 175), (135, 40), "#text_box_22_horizleft"
        )
        self.tortie_colour_label = create_text_box(
            "tortie colour", (480, 175), (135, 40), "#text_box_22_horizleft"
        )
        self.tortie_pattern_label = create_text_box(
            "tortie pattern", (640, 175), (135, 40), "#text_box_22_horizleft"
        )
        self.white_patches_label = create_text_box(
            "white patches", (320, 260), (135, 40), "#text_box_22_horizleft"
        )
        self.vitiligo_label = create_text_box(
            "vitiligo", (480, 260), (135, 40), "#text_box_22_horizleft"
        )
        self.points_label = create_text_box(
            "point", (640, 260), (135, 40), "#text_box_22_horizleft"
        )
        self.white_patches_tint_label = create_text_box(
            "white patches tint", (320, 335), (135, 40), "#text_box_22_horizleft"
        )
        self.tint_label = create_text_box(
            "tint", (480, 335), (135, 40), "#text_box_22_horizleft"
        )
        self.skin_label = create_text_box(
            "skin", (640, 335), (135, 40), "#text_box_22_horizleft"
        )
        self.reset_message = create_text_box(
            "Changes cannot be reset after leaving this cat's customization page.",
            (25, 395),
            (270, 60),
            "#text_box_26_horizcenter",
        )
        self.eye_colour1_label = create_text_box(
            "eye colour 1", (320, 420), (135, 40), "#text_box_22_horizleft"
        )
        self.heterochromia_text = create_text_box(
            "heterochromia", (495, 451), (135, 40), "#text_box_26_horizcenter"
        )
        self.eye_colour2_label = create_text_box(
            "eye colour 2", (640, 420), (135, 40), "#text_box_22_horizleft"
        )
        self.accessory_label = create_text_box(
            "accessory", (568, 500), (135, 40), "#text_box_22_horizleft"
        )
        self.pose_label = create_text_box(
            "pose", (406, 500), (110, 40), "#text_box_22_horizleft"
        )
        self.reverse_label = create_text_box(
            "reverse", (52, 500), (135, 40), "#text_box_22_horizleft"
        )
        self.scar_message = create_text_box(
            "Adding/removing scars will not affect a cat's conditions or history.",
            (52, 650),
            (500, 40),
            "#text_box_26_horizleft",
        )
        self.scar1_label = create_text_box(
            "scar 1", (56, 580), (135, 40), "#text_box_22_horizleft"
        )
        self.scar2_label = create_text_box(
            "scar 2", (242, 580), (135, 40), "#text_box_22_horizleft"
        )
        self.scar3_label = create_text_box(
            "scar 3", (428, 580), (135, 40), "#text_box_22_horizleft"
        )
        self.scar4_label = create_text_box(
            "scar 4", (614, 580), (135, 40), "#text_box_22_horizleft"
        )
        """------------------------------------------------------------------------------------------------------------#
        #                                              LABEL SETUP END                                                 #
        # ------------------------------------------------------------------------------------------------------------"""
    ...
    def setup_dropdowns(self):
        ...
        self.white_patches_tint_dropdown = create_dropdown(
            ...
            get_selected_option(self.the_cat.pelt.white_patches_tint, "lower"),
        )
        self.tint_dropdown = create_dropdown(
            (480, 360),
            (135, 40),
            create_options_list(self.tints, "lower"),
            get_selected_option(self.the_cat.pelt.tint, "lower"),
        )
        self.skin_dropdown = create_dropdown(
            (640, 360),
            (135, 40),
            create_options_list(self.skins, "upper"),
            get_selected_option(self.the_cat.pelt.skin, "upper"),
        )
        self.eye_colour1_dropdown = create_dropdown(
            (320, 445),
            (135, 40),
        ...
        self.eye_colour2_dropdown = create_dropdown(
            ...
            create_options_list(self.eye_colours, "upper"),
            (
                get_selected_option(self.the_cat.pelt.eye_colour2, "upper")
                if self.the_cat.pelt.eye_colour2
                else get_selected_option(self.the_cat.pelt.eye_colour, "upper")
            ),
        )
        self.accessory_dropdown = create_dropdown(
            (568, 525),
            (180, 40),
            create_options_list(self.accessories, "upper"),
            get_selected_option(self.the_cat.pelt.accessory, "upper"),
            "dropup",
        )

        scars = self.the_cat.pelt.scars
        self.scar1_dropdown = create_dropdown(
            (52, 605),
            (135, 40),
            create_options_list(self.scars, "upper"),
            get_selected_option(scars, "upper"),
            "dropup",
        )
        self.scar2_dropdown = create_dropdown(
            (238, 605),
            (135, 40),
            create_options_list(self.scars, "upper"),
        ...
        self.scar3_dropdown = create_dropdown(
            (424, 605),
            (135, 40),
            create_options_list(self.scars, "upper"),
        ...
        self.scar4_dropdown = create_dropdown(
            (610, 605),
            (135, 40),
            create_options_list(self.scars, "upper"),
    ...
    def setup_pelt_length(self):
        self.cat_elements["pelt_length_index"] = self.pelt_lengths.index(
            self.the_cat.pelt.length
        )
    ...
    def setup_poses(self):
        ...
        self.set_poses()
        self.cat_elements["current_pose"] = self.the_cat.pelt.cat_sprites[
            self.life_stage
        ]
    ...
    def make_cat_sprite(self):
        ...
        self.cat_image = generate_sprite(
            self.the_cat, self.life_stage, False, False, True, True
        )
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            if event.ui_element == self.previous_cat_button:
                ...
                self.pelt_length_left_button,
                self.pelt_length_right_button,
            ]:
            ...
            if event.ui_element == self.pelt_name_dropdown:
                ...
                self.handle_dropdown_change(
                    self.tortie_pattern_dropdown, "tortiepattern"
                )
                ...
                self.handle_dropdown_change(
                    self.white_patches_tint_dropdown, "white_patches_tint"
                )
    ...
    def handle_back_button(self):
        if (
            self.the_cat.pelt.eye_colour2 == self.the_cat.pelt.eye_colour
        ):  # remove second eye colour if same as first
            self.the_cat.pelt.eye_colour2 = None

        self.the_cat.pelt.scars = list(
            set(self.the_cat.pelt.scars)
        )  # deduplicate scars
    ...
    def handle_scar_dropdown(self, dropdown):
        ...
        if (
            ...
            and previous_selection in self.the_cat.pelt.scars
        ):
            self.the_cat.pelt.scars.remove(
                previous_selection
    ...
    def handle_sprites_for_pelt_length(self, previous_length):
        ...
        if is_long_to_not_long or is_not_long_to_long:
            self.set_poses()
            if (
                self.life_stage != "newborn" and not self.the_cat.pelt.paralyzed
            ):  # check for special statuses
                self.cat_elements["current_pose"] = self.poses[0]

            if self.life_stage == "adult":
                if (
                    not self.the_cat.pelt.paralyzed
                ):  # update adult sprites to current pose if not paralyzed
                    self.the_cat.pelt.cat_sprites["young adult"] = self.cat_elements[
                        "current_pose"
                    ]
                    self.the_cat.pelt.cat_sprites["adult"] = self.cat_elements[
                        "current_pose"
                    ]
                    self.the_cat.pelt.cat_sprites["senior adult"] = self.cat_elements[
                        "current_pose"
                    ]
    ...
    def change_pelt_length(self, direction):
        ...
        self.cat_elements["pelt_length_index"] = (
            self.cat_elements["pelt_length_index"] + direction
        ) % len(self.pelt_lengths)
        self.the_cat.pelt.length = self.pelt_lengths[
            self.cat_elements["pelt_length_index"]
        ]
        self.update_pelt_length_display()
    ...
    def update_pelt_length_display(self):
        ...
        self.cat_elements["pelt_length"] = create_text_box(
    ...
    def check_if_tortie(self, new_pelt_name, previous_pelt_name):
        ...
        if new_pelt_name in ["Calico", "Tortie"]:
            ...
            self.pattern_dropdown = create_dropdown(
                (640, 125), (135, 40), "None", "None"
            )
            self.tortie_base_dropdown = create_dropdown(
                (320, 200), (135, 40), "None", "None"
            )
            self.tortie_colour_dropdown = create_dropdown(
                (480, 200), (135, 40), "None", "None"
            )
            self.tortie_pattern_dropdown = create_dropdown(
                (640, 200), (135, 40), "None", "None"
            )
    ...
    def make_heterochromia_checkbox(self):
        ...
        checkbox_id = (
            "@checked_checkbox" if self.heterochromia else "@unchecked_checkbox"
        )
    ...
    def change_pose(self, direction):
        ...
        self.the_cat.pelt.cat_sprites[self.life_stage] = self.cat_elements[
            "current_pose"
        ]
        if self.life_stage == "adult":
            self.the_cat.pelt.cat_sprites["young adult"] = self.cat_elements[
    ...
    def update_pose_display(self):
        ...
        pose_text = (
            "none"
            if (self.the_cat.pelt.paralyzed or self.life_stage == "newborn")
            else str(self.cat_elements["current_pose"])
        )
        self.cat_elements["pose"] = create_text_box(
            pose_text, (436, 530), (50, 40), "#text_box_26_horizcenter"
        )
    ...
    def update_reverse_display(self):
        ...
        self.cat_elements["reverse"] = create_text_box(
            reverse_text, (52, 530), (45, 40), "#text_box_26_horizcenter"
        )
    ...
    def kill_labels(self):
        labels = [
            self.pelt_name_label,
            self.pelt_colour_label,
            self.pelt_length_label,
            self.pattern_label,
            self.tortie_base_label,
            self.tortie_colour_label,
            self.tortie_pattern_label,
            self.white_patches_label,
            self.vitiligo_label,
            self.points_label,
            self.white_patches_tint_label,
            self.tint_label,
            self.skin_label,
            self.eye_colour1_label,
            self.eye_colour2_label,
            self.heterochromia_text,
            self.reset_message,
            self.pose_label,
            self.reverse_label,
    ...
    def kill_buttons(self):
        buttons = [
            ...
            self.pelt_length_left_button,
            self.pelt_length_right_button,
            self.pose_left_button,
            self.pose_right_button,
            self.reverse_button,
        ]
    ...
    def kill_dropdowns(self):
        dropdowns = [
            self.pelt_name_dropdown,
            self.pelt_colour_dropdown,
            self.pattern_dropdown,
            self.tortie_base_dropdown,
            self.tortie_colour_dropdown,
            self.tortie_pattern_dropdown,
            self.white_patches_dropdown,
            self.vitiligo_dropdown,
            self.points_dropdown,
            self.skin_dropdown,
            self.white_patches_tint_dropdown,
            self.tint_dropdown,
            self.eye_colour1_dropdown,
            self.eye_colour2_dropdown,
            self.accessory_dropdown,
            self.scar1_dropdown,
            self.scar2_dropdown,
            self.scar3_dropdown,
            self.scar4_dropdown,
