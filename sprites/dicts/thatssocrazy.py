...
with open("white_patches_mostly_sprite_data.json", "r", encoding="utf-8") as read_file:
    WHITE_MOSTLY_DATA = ujson.loads(read_file.read())
with open("white_patches_high_sprite_data.json", "r", encoding="utf-8") as read_file:
    WHITE_HIGH_DATA = ujson.loads(read_file.read())
with open("white_patches_mid_sprite_data.json", "r", encoding="utf-8") as read_file:
    WHITE_MID_DATA = ujson.loads(read_file.read())
with open("white_patches_little_sprite_data.json", "r", encoding="utf-8") as read_file:
    WHITE_LITTLE_DATA = ujson.loads(read_file.read())

try:
    with open("white_patches_combos.json", "r", encoding="utf-8") as read_file:
...
with open(f"thebigjson.json", "x") as write_file:
